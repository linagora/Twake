...
class MailSender implements MailSenderInterface
{
    ...
    public function sendBill($group, $pathFiles){
        ...
        foreach ($list as $user){
            ...
            $this->mailer->send($mail, "Bill", Array("_language" => $user->getLanguage(), "username" => $username), "TwakePaymentsBundle:Mail", $pathFiles);
        }
    }
    ...
    public function sendEndPeriodsMail($group, $timeleft){
        ...
        foreach ($list as $user){
            $mail = $user["mail"];
            $username = $user["username"];
            $this->mailer->send($mail, "endPeriod", Array("_language" => $user->getLanguage(), "timeleft" => $timeleft, "username" => $username), "TwakePaymentsBundle:Mail");
        }
    }
    ...
    public function sendIsOverUsingALittle($group, $overuse){
        ...
        foreach ($list as $user){
            $mail = $user["mail"];
            $username = $user["username"];
            $this->mailer->send($mail, "IsOverUsingALittle", Array("_language" => $user->getLanguage(), "overuse" => $overuse, "username" => $username), "TwakePaymentsBundle:Mail");
        }
    }
    ...
    public function sendWillBeOverUsing($group, $overuse){
        ...
        foreach ($list as $user){
            $mail = $user["mail"];
            $username = $user["username"];
            $this->mailer->send($mail, "WillBeOverUsing", Array("_language" => $user->getLanguage(), "overuse" => $overuse, "username" => $username), "TwakePaymentsBundle:Mail");
        }
    }
    ...
    public function sendIsOverUsingALot($group, $overuse){
        ...
        foreach ($list as $user){
            $mail = $user["mail"];
            $username = $user["username"];
            $this->mailer->send($mail, "IsOverUsingALot", Array("_language" => $user->getLanguage(), "overuse" => $overuse, "username" => $username), "TwakePaymentsBundle:Mail");
        }
    }
    ...
    public function sendDirectDebitNotification($group, $howMuch){
        ...
        foreach ($list as $user){
            $mail = $user["mail"];
            $username = $user["username"];
            $this->mailer->send($mail, "DirectDebitNotification", Array("_language" => $user->getLanguage(), "howMuch" => $howMuch, "username" => $username), "TwakePaymentsBundle:Mail");
        }
    }
    ...
    public function sendUnpaidSubscription($group){
        ...
        foreach ($list as $user){
            $mail = $user["mail"];
            $username = $user["username"];
            $this->mailer->send($mail, "UnpaidSubscription", Array("_language" => $user->getLanguage(), "username" => $username), "TwakePaymentsBundle:Mail");
        }
    }
