...
use WebsiteApi\DriveUploadBundle\Services\ZipStream\Option\Archive as ArchiveOptions;
...
class ZipStream
{
     ...
     * @return void
     */
    public function addFileFromStream(string $name, $stream, $options = null): void
    {
        $options = $options ?: new FileOptions();
        $options->defaultTo($this->opt);
