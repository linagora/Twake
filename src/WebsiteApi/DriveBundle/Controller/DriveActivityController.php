...
class DriveActivityController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        $workspace_id = $this->get("app.twake_doctrine")->getManager()->getRepository("TwakeWorkspacesBundle:Workspace")->find($workspace_id_tmp);
        $application = $this->get("app.twake_doctrine")->getManager()->getRepository("TwakeMarketBundle:Application")->find($application_tmp);
    ...
    public function readOneAction(Request $request){
        ...
        $workspaceId = $this->get("app.twake_doctrine")->getManager()->getRepository("TwakeWorkspacesBundle:Workspace")->find($workspace_id);
