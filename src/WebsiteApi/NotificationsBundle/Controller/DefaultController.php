...
class DefaultController extends Controller
{
    public function initAction()
    {
        ...
        $messages = $this->get("app.doctrine_adapter")->getManager()->getRepository("TwakeMarketBundle:Application")->findOneBy(Array("publicKey" => "messages"));
    ...
    public function deleteAction(Request $request){
        ...
        $workspace_id = $this->get("app.doctrine_adapter")->getManager()->getRepository("TwakeWorkspacesBundle:Workspace")->findOneBy(Array("id" => $workspace_id_tmp));
        $application = $this->get("app.doctrine_adapter")->getManager()->getRepository("TwakeMarketBundle:Application")->findOneBy(Array("id" => $application_id));
