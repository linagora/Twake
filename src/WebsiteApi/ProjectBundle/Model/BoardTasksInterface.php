...
interface BoardTasksInterface
{
    ...
    public function updateTask($taskId, $taskArray, $name, $description, $startDate, $endDate, $dependingTaskId, $userId, $userToNotify, $participants, $weight, $labels, $status, $checklist);
