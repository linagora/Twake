...
$en = Array(
    ...
    "workspace.activity.workspace.change_logo" => "$1 has changed $2 times the logo",
    "workspace.activity.workspace.rename" => "$1 has renamed $2 times the workspace",
    "workspace.activity.workspace.change_wallpaper" => "$1 has changed $2 times the wallpaper",
    "workspace.activity.workspace.archive" => "$1 has archived $2 times the workspace",
    "workspace.activity.workspace.unarchive" => "$1 has unarchived $2 times the workspace",
    "workspace.activity.workspace.add_member" => "$1 has added $2 members",
);