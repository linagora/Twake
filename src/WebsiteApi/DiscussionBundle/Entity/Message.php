...
class Message
{
    ...
    public function getArray(){
        ...
        return Array(
            ...
            "userSender" => ($this->getUserSender()!=null)?$this->getUserSender()->getAsSimpleArray():null,
            "recieverType" => $this->getTypeReciever(),
            "streamReciever" => ($this->getStreamReciever()!=null)?$this->getStreamReciever()->getArray():null,
            "userReciever" => ($this->getUserReciever()!=null)?$this->getUserReciever()->getAsSimpleArray():null,
