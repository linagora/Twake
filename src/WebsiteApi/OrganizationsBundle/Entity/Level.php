<?php
     ...
     * @ORM\Entity(repositoryClass="WebsiteApi\OrganizationsBundle\Repository\LevelRepository")
     */
    class Level
    {
        /**
	    ...
	    /**
	     * @ORM\OneToMany(targetEntity="WebsiteApi\OrganizationsBundle\Entity\LinkOrgaUser", mappedBy="level")
	     */
	    private $members;
