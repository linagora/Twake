 ...
 * Orga
 *
 * @ORM\Table(name="orga",options={"engine":"MyISAM"})
 * @ORM\Entity(repositoryClass="WebsiteApi\CoreBundle\Repository\OrgaRepository")
 */
class Orga
{
	...
	/**
	 * @ORM\OneToMany(targetEntity="WebsiteApi\OrganizationsBundle\Entity\LinkOrgaUser", mappedBy="Orga")
	 */
	private $members;
	/**
	 * @ORM\OneToMany(targetEntity="WebsiteApi\MarketBundle\Entity\LinkAppOrga", mappedBy="organization")
	 */
	private $apps;
	/**
	 * @ORM\OneToMany(targetEntity="WebsiteApi\OrganizationsBundle\Entity\Level", mappedBy="groupe")
	 */
	private $levels;
	/**
	 * @ORM\OneToMany(targetEntity="WebsiteApi\DiscussionBundle\Entity\Channel", mappedBy="organization")
	 */
	private $channels;
	/**
	 * @ORM\OneToMany(targetEntity="WebsiteApi\MarketBundle\Entity\LinkAppOrga", mappedBy="organization")
	...
	/**
	 * @ORM\OneToMany(targetEntity="WebsiteApi\OrganizationsBundle\Entity\LinkOrgaParent", mappedBy="parent")
	 */
	private $children;
	/**
	 * @ORM\OneToMany(targetEntity="WebsiteApi\PaymentsBundle\Entity\PaymentsHistory", mappedBy="organization")
	 */
	...
	{
		//$number = bcmod(bcmul($identifier - Orga::$max_users, Orga::$retrieve_number), Orga::$max_users);
        $number = 0;
        return $number;
	}
	...
	{
		return mb_strtoupper(Orga::toAlphabeticalCode(Orga::getKeyFromId($this->getId())));
	}
	...
	{
		//$number = Orga::$max_users + bcmod($id * Orga::$primary_number, Orga::$max_users);
        $number = 0;
        return $number;
	}
