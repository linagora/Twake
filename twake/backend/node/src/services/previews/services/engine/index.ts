...
export class PreviewEngine implements Initializable {
  constructor(private service: PreviewServiceAPI, private pubsub: PubsubServiceAPI) {}

  async init(): Promise<this> {
    this.pubsub.processor.addHandler(new PreviewProcessor(this.service, this.pubsub));
