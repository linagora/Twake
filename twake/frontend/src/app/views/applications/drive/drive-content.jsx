...
import PathElement from './path-element.jsx';
import AlertManager from 'app/features/global/services/alert-manager-service';

import UnconfiguredTab from './unconfigured-tab.jsx';
import Viewer from './viewer/drive-deprecated-viewer';
...
import DriveList from './lists/list.jsx';
          ...
          >
            ...
            {(files.length + directories.length > 0 ||
              ...
              <div>
                ...
                {directories.length > 0 && [<br key="break1" />, <br key="break2" />]}
