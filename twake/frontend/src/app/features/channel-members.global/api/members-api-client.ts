import { ChannelMemberType } from "app/features/channel-members.global/types/channel-members";
...
import { ParamsChannelMember, PayloadChannelMemberType, ResponseChannelMemberType, ResponseChannelMemberTypeList } from "../types/channel-members";
...
class ChannelMembersApiClient {
    ...
    async addMember(
        member: Partial<ChannelMemberType>,
