...
export const Button = (props: ButtonProps) => {
  ...
  if (props.theme === "secondary")
    colors =
      "text-blue-600 bg-blue-100 hover:bg-blue-200 active:bg-blue-300 border-transparent ";
  ...
  if (props.theme === "default")
    colors =
      "text-black bg-white hover:bg-gray-50 active:bg-gray-200 border-gray-300";
  ...
  return (
    <button
      type="button"
      className={
        "inline-flex items-center px-4 py-2 border text-sm font-medium rounded-xl focus:outline-none " +
        colors +
        " " +
        props.className
      }
