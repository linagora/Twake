...
import ComponentsTester from 'components/ComponentsTester/ComponentsTester.js';
  ...
  componentDidCatch(error, info) {
    if (!this.state.hasError) {
      ...
      window.loadBundle(
        ...
        () => {},
        () => {
          window.loadBundle('/public/js/fireworks.js', () => {}, () => {});
        },
      );
    }
  }
          ...
          <div className="error_message skew_in_top">
            ...
            <div className="text">
              ...
              {LoginService.server_infos.help_link && (
                <span>
                  Please tell us what you were doing at :<br />
