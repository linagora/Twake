...
----------------------------------------------------------------------------------------------------------------------*/
        ...
        function compareByFieldSpec(obj1, obj2, fieldSpec) {
          ...
          return (
            flexibleCompare(obj1[fieldSpec.field], obj2[fieldSpec.field]) * (fieldSpec.order || 1)
          );
        }
...
*/
    ...
    */
          EventDateProfile.prototype.buildUnzonedRange = function(calendar) {
            var startMs = this.start
              .clone()
              .stripZone()
              .valueOf();
            var endMs = this.getEnd(calendar)
              .stripZone()
              .valueOf();
            ...
            for (i = 0; i < eventInstances.length; i++) {
              ...
              if (slicedRange) {
                slicedEventRanges.push(
                  new EventRange_1.default(slicedRange, eventInstance.def, eventInstance),
                );
              }
            }
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        function datepickerLocale(localeCode, dpLocaleCode, dpOptions) {
          ...
          if (jqDatePicker) {
            ...
            jqDatePicker.regional[dpLocaleCode] = jqDatePicker.regional[localeCode] = dpOptions; // alias
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var InteractiveDateComponent = /** @class */ (function(_super) {
          ...
          InteractiveDateComponent.prototype.bindAllSegHandlersToEl = function(el) {
            [this.eventPointing, this.eventDragging, this.eventResizing].forEach(function(
              eventInteraction,
            ) {
              if (eventInteraction) {
...
*/
    ...
    ------------------------------------------------------------------------------------------------------------------*/
          ...
          DayTableMixin.prototype.renderHeadDateCellHtml = function(date, colspan, otherAttrs) {
            ...
            var innerHtml =
              "<div class='number'>" +
              util_1.htmlEscape(date.format('D')) +
              "</div><div class='day'>" +
              util_1.htmlEscape(date.format('ddd')) +
              '</div>';
        ...
        function makeDayGridSubclass(SuperClass) {
          return /** @class */ (function(_super) {
            ...
            SubClass.prototype.getIsNumbersVisible = function() {
              return (
                DayGrid_1.default.prototype.getIsNumbersVisible.apply(this, arguments) ||
        ...
        var Calendar = /** @class */ (function() {
          ...
          Calendar.prototype.initialRender = function() {
            ...
            this.optionsManager.watch(
              ...
              ['?businessHours'],
              function(deps) {
                _this.businessHourGenerator = new BusinessHourGenerator_1.default(
                  deps.businessHours,
                  _this,
                );
                if (_this.view) {
    ...
    */
          ...
          Constraints.prototype.collectOverlapEventFootprints = function(
            ...
            for (i = 0; i < peerEventFootprints.length; i++) {
              if (
                this.footprintsIntersect(targetFootprint, peerEventFootprints[i].componentFootprint)
              ) {
        ...
        var FuncEventSource = /** @class */ (function(_super) {
          ...
          FuncEventSource.prototype.fetch = function(start, end, timezone) {
            ...
            return Promise_1.default.construct(function(onResolve) {
              _this.func.call(_this.calendar, start.clone(), end.clone(), timezone, function(
                rawEventDefs,
              ) {
            ...
            var dragListener = (this.dragListener = new HitDragListener_1.default(component, {
              ...
              hitOver: function(hit) {
                ...
                if (hitFootprint) {
                  ...
                  if (singleEventDef) {
                    mutatedEventInstanceGroup = new EventInstanceGroup_1.default(
          ...
          TimeGrid.prototype.renderSlatRowHtml = function() {
            ...
            while (slotTime < dateProfile.maxTime) {
              ...
              isLabeled = util_1.isInt(
                util_1.divideDurationByDuration(slotIterator, this.labelInterval),
              );
              axisHtml =
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var EventPeriod = /** @class */ (function() {
          ...
          EventPeriod.prototype.removeEventInstancesForDef = function(eventDef) {
            ...
            var removeCnt;
            if (eventInstanceGroup) {
              removeCnt = util_1.removeMatching(eventInstanceGroup.eventInstances, function(
        ...
        var MouseFollower = /** @class */ (function() {
          ...
          MouseFollower.prototype.getEl = function() {
            ...
            if (!el) {
              ...
              // we don't want long taps or any mouse interaction causing selection/Layout.
          ...
          TimeGridEventRenderer.prototype.fgSegHtml = function(seg, disableResizing) {
            ...
            return (
              ...
              (timeText
                ...
                : '') +
              (eventDef.title
                ? '<div class="fc-title">' + util_1.htmlEscape(eventDef.title) + '</div>'
                : '') +
              '</div>' +
              '<div class="fc-bg"/>' +
