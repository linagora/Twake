  ...
  c(function(c) {
    ...
    if ('object' === typeof process && process.nextTick) C = process.nextTick;
      ...
      (r =
        ...
        ('function' === typeof WebKitMutationObserver && WebKitMutationObserver))
    )
      C = (function(a, b, e) {
...
a.debug = function(b, d, h) {
  if ('console' in c)
    (a._debugrpc = b), (a._debugpubsub = b), (a._debugws = d), (a._debugconnect = h);
...
a.Deferred = CryptoJS.defer;
a._construct = function(a, d) {
  return new WebSocket(a, d);
};
a.Session = function(b, d, c, f) {
  ...
  e._websocket.onopen = function(b) {
    if (e._websocket.protocol !== a._subprotocol)
      if ('undefined' === typeof e._websocket.protocol)
        ...
        throw (e._websocket.close(1e3, 'server does not speak WAMP'),
        "server does not speak WAMP (but '" + e._websocket.protocol + "' !)");
    a._debugws &&
  ...
  e._websocket.onclose = function(b) {
    ...
    void 0 !== e._websocket_onclose &&
      (e._websocket_connected
        ? b.wasClean
          ? e._websocket_onclose(a.CONNECTION_CLOSED, 'WS-' + b.code + ': ' + b.reason)
  ...
  e.log = function() {
    e._options && 'sessionIdent' in e._options
      ? console.group("WAMP Session '" + e._options.sessionIdent + "' [" + e._session_id + ']')
...
a.Session.prototype.call = function() {
  ...
  this._calls[d] = b;
  for (
    var c = this._prefixes.shrink(arguments[0], !0), c = [a._MESSAGE_TYPEID_CALL, d, c], f = 1;
    f < arguments.length;
    f += 1
  )
    c.push(arguments[f]);
        ...
        case a.CONNECTION_UNREACHABLE:
          ...
          if (0 === b.connects) b.onHangup(d, 'Connection could not be established.');
            ...
            (e = b.onHangup(
              ...
              ? (a._debugconnect && console.log('Connection unreachable - retrying stopped by app'),
                b.onHangup(a.CONNECTION_RETRIES_EXCEEDED, 'Number of connection retries exceeded.'))
              : (a._debugconnect &&
                  console.log('Connection unreachable - retrying (' + b.retryCount + ') ..'),
                setTimeout(function() {
                  a._connect(b);
        ...
        case a.CONNECTION_LOST:
          ...
          if (b.retryCount <= b.options.maxRetries)
            (e = b.onHangup(
              ...
              ? (a._debugconnect && console.log('Connection lost - retrying stopped by app'),
                b.onHangup(a.CONNECTION_RETRIES_EXCEEDED, 'Connection lost.'))
              : (a._debugconnect &&
                  console.log('Connection lost - retrying (' + b.retryCount + ') ..'),
                setTimeout(function() {
                  a._connect(b);
                }, b.options.retryDelay));
      ...
      !b.appkey || '' === b.appkey
        ...
        : c.authreq(b.appkey, b.appextra).then(function(e) {
            ...
            'function' === typeof b.appsecret
              ? (g = b.appsecret(e))
              : ((g = a.deriveKey(b.appsecret, JSON.parse(e).authextra)), (g = c.authsign(e, g)));
...
// End defining autobahn

window.autobahn = (function() {
...
class Autobahn {
  constructor() {
    Globals.autobahn = window.autobahn;
  }
}

const autobahn_compatible = new Autobahn();
export default autobahn_compatible;
