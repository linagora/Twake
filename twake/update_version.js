...
const versions = {
  ...
  VERSION: process.env.TWAKE_VERSION || "2021.Q3",
  VERSION_DETAIL: process.env.TWAKE_VERSION_DETAIL || "2021.Q3.735",
  MIN_VERSION_WEB: process.env.TWAKE_MIN_VERSION_WEB || "2021.Q3.735",
  MIN_VERSION_MOBILE: process.env.TWAKE_MIN_VERSION_MOBILE || "2021.Q3.735",
};
