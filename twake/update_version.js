...
const versions = {
  ...
  VERSION_DETAIL: process.env.TWAKE_VERSION_DETAIL || "2021.Q1.137",
  MIN_VERSION_WEB: process.env.TWAKE_MIN_VERSION_WEB || "2021.Q1.136",
  MIN_VERSION_MOBILE: process.env.TWAKE_MIN_VERSION_MOBILE || "2021.Q1.136",
};
