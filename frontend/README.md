...
You don’t have to use [React Bootstrap](https://antd.github.io) together with React but it is a popular library for integrating Bootstrap with React apps. If you need it, you can integrate it with Create React App by following these steps:

Install React Bootstrap and Bootstrap from npm. React Bootstrap does not include Bootstrap CSS so this needs to be installed as well:

```sh
npm install --save antd bootstrap@3
```

Alternatively you may use `yarn`:

```sh
yarn add antd bootstrap@3
```
...
```js
import { Navbar, Jumbotron, Button } from 'antd';
```
...
```sh
    ...
    Firebase Collections Database Rules allow you to define how your data should be
