  ...
  return (function(e) {
    ...
    function(e, t, n) {
      ...
      function s(e) {
        ...
        var h = void 0;
        if (
          (r && ((h = r[1]), (e = e.substring(n.lastIndex))),
          h ? h.startsWith('/') || (h = '/' + h) : (h = '/'),
          (t.pathname = h),
          e.startsWith('?'))
        ) {
          var f = e.indexOf('#', 1);
      ...
      function a(e) {
        ...
        !v ||
          (!t.pathname.endsWith('/') && t.pathname.endsWith('/' + v)) ||
          (o.endsWith('/') || (o += '/'), (o += v)),
          (t.pathname = o);
        var d = e.jwt;
        if (d) {
      ...
      function r() {
        ...
        if (!(s[t] < e.level))
          for (var i = n(), a = o.concat(e.transports), l = 0; l < a.length; l++) {
            ...
            c &&
              'function' == typeof c &&
              c.bind(u, e.id ? '[' + e.id + ']' : '', '<' + i.methodName + '>: ').apply(u, r);
          }
      }
        ...
        function(e) {
          ...
          function c(e) {
            var t = void 0,
              n = /([0-9]*\.?[0-9]+)(em|pt|px|%)$/;
            return (
              'string' == typeof e && null !== String(e).match(n)
                ? (t = e)
            ...
            k = (function(e) {
              function t(e) {
                ...
                return (
                  ...
                  (n._baseUrl = (E ? 'http' : 'https') + '://' + e + '/'),
                  n._createIFrame(m, p),
                  (n._transport = new d.b({
                    backend: new d.a({
                      postisOptions: {
      ...
      (e.exports = n),
        ...
        (n.prototype.emit = function(e) {
          ...
          if (r(n))
            ...
            for (
              a = Array.prototype.slice.call(arguments, 1), u = n.slice(), i = u.length, l = 0;
              l < i;
              l++
            )
              u[l].apply(this, a);
    ...
    function(e, t, n) {
      ...
      var a = (function(e) {
                ...
                .forEach(function(e) {
                  ...
                  if (r) {
                    ...
                    try {
                      ...
                      return (
                        console.warn(o, e),
                        void (window.onerror && window.onerror(o, null, null, null, e))
                      );
                    }
                    i[r] = s;
                  }
        ...
        f = { window: window.opener || window.parent },
        v = [
          'avatar-url',
          'display-name',
          'email',
      ...
      var w = {};
      'number' == typeof a && (w.scope = 'jitsi_meet_external_api_' + a),
        ((function() {
          return (
    ...
    function(e, t) {
      function n(e) {
        ...
        var c = {
            ...
            send: function(e) {
              var t = e.method;
              (l || '__ready__' === e.method) && r && 'function' == typeof r.postMessage
                ? r.postMessage(
                    JSON.stringify({
                      postis: !0,
                      scope: n,
